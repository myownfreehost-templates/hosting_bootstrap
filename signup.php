...
<body>
<div class="container">
<nav class="navbar navbar-light bg-light shadow p-3 mb-5 bg-body-tertiary rounded">
  <br><br><div class="alert alert-light order-first">
  <h2><b><img src="/home.svg"></img>&nbsp;<?echo $yourdomain;?></b></h2>
</div>
...
<div class="container"><center><div class="alert alert-success shadow p-3 mb-5 bg-body-tertiary rounded" role="alert">
  <h4 class="alert-heading"><?= _WHAT_IS_THIS ?></h4>
  <hr>
  <p class="mb-0"><?= _ABOUT_THIS_WEBSITE ?></p>
</div></center><div class="row">
<div class="col-md-6 shadow p-3 mb-5 bg-body-tertiary rounded"><p>
...
</form></div></p></div></div></div>
<nav class="navbar fixed-bottom navbar-light bg-light shadow bg-body-tertiary rounded">
<div class="container">
