...
<p><input class="form-control" placeholder="<?= _USERNAME ?>" name="uname" type="text" alt="username" id="save_uname" oninvalid="this.setCustomValidity('Enter username')" oninput="setCustomValidity('')" required></p>
<p><div class="input-group mb-3"><input class="form-control" placeholder="<?= _PASSWORD ?>" type="password" name="passwd" alt="password" id="save_passwd" oninvalid="this.setCustomValidity('Enter password')" oninput="setCustomValidity('')" required>  <div class="input-group-append">
    <span><div><input type="checkbox" class="btn-check" id="btn-check-outlined" autocomplete="off" onclick="ShowPassword()"><label class="btn btn-outline-dark" for="btn-check-outlined">&#128065;</label>
</div></span>
  </div>
</div>
</p>
...
<center><p><div class="input-group d-flex justify-content-center"><img class="img-thumbnail" src="http://order.<? echo $yourdomain;?>/image.php?id=<?PHP echo $id; ?>"><div class="input-group-append d-flex justify-content-center">
    <center><input class="form-control" placeholder="<?= _CODE ?>" type=text pattern=".{5,5}" name=number oninvalid="this.setCustomValidity('Enter security code')" oninput="setCustomValidity('')" required>
</div>
</div></p></center>
