...
<p><input class="form-control" placeholder="<?= _CODE ?>" type=text pattern=".{5,5}" name=number oninvalid="this.setCustomValidity('Enter security code')" oninput="setCustomValidity('')" required></p>
<center><p><button type="submit" class="btn btn-primary"><?= _SIGNUP ?></button> <img class="img-thumbnail" src="http://order.<? echo $yourdomain;?>/image.php?id=<?PHP echo $id; ?>"></p></center>
